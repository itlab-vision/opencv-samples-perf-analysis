...
parser.add_argument("-ifn", '--in_file_name', type=str, default="erosion_08_21.out")
parser.add_argument("-ofn", '--out_file_name', type=str, default="erosion_08_21.xlsx")
...
for exp in file_array:
    ...
    curr_df.loc[esize, "input resolution"] = input_resolution
    curr_df.loc[esize, "Erosion size: "] = esize
    curr_df.loc[esize, type] = time
